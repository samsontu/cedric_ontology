 ...
 * [cedric.yml](cedric.yml)
     * Determines how your purl.obolibrary.org/obo/cedric/ redirects will be handled
     ...
     * Paste in the contents of [cedric.yml](cedric.yml)
 ...
 * [cedric.md](cedric.md)
     ...
     * Paste in the contents of [cedric.md](cedric.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
